...
1.	Motor de IA Generativa Hibrido: Se migró el algoritmo básico de palabras clave a una integración avanzada con la API de Gemini 2.5 Flash, permitiendo que el asistente responda con lenguaje natural y técnico avanzado cuando no encuentra una respuesta dentro de la base de datos entrenada manualmente.
...
Desarrollado por: Rubén Elí Durán Ramírez Institución: ESIT 2025-2026
