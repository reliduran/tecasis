        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                 ...
                 <li>
                    ...
                    <?php echo htmlspecialchars($nosotros['telefono']); ?>
                </li>
                <!-- Correo Dinámico -->
                    <li>
                    <i class="fa-solid fa-envelope"></i> 
                    <?php echo htmlspecialchars($nosotros['email_contacto']); ?>
                    </li>
                </ul>
            </div>
        </div>
      <div style="text-align: center; border-top: 1px solid rgba(255,255,255,0.1); padding: 20px 0; width: 100%; clear: both;">
